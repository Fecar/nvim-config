...
local function set_mappings()
  ...
  local mappings = {
    ...
    { "n", "<leader>bb", "<Cmd>BufferOrderByBufferNumber<CR>", { noremap = true, desc = "Buffer Order by Number" } },
    { "n", "<leader>bn", "<Cmd>BufferOrderByName<CR>",         { noremap = true, desc = "Buffer Order by Name" } },
    { "n", "<leader>bd", "<Cmd>BufferOrderByDirectory<CR>",    { noremap = true, desc = "Buffer Order by Directory" } },
    { "n", "<leader>bl", "<Cmd>BufferOrderByLanguage<CR>",     { noremap = true, desc = "Buffer Order by Language" } },
    { "n", "<leader>bw", "<Cmd>BufferOrderByWindowNumber<CR>", { noremap = true, desc = "Buffer Order by Windows Number" } },
  }
